import { Suspense, useRef, useCallback, useEffect, type MutableRefObject } from 'react';
...
import type { UVCoordinate, HandleType } from '@/types';
import { SELECTED_COLOR } from '@/utils/colors';

interface PanoramaCanvasProps {
  cameraRef: MutableRefObject<CameraControllerHandle | null>;
}
...
export function PanoramaCanvas({ cameraRef }: PanoramaCanvasProps) {
  const {
    boxes,
    selectedBoxId,
    selectBox,
